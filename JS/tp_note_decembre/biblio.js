...
/******************************************************************************************************/		
		...
		extend(Array.prototype,{
			...
			max		:	function(){
							// Si la première valeur du tableau est null cela veut dire que le tableau est vide
							if(this[0] != null && !isNaN(this[0])){
								// J'ai été obligé d'utiliser var car en utilisant let, ma variable n'est pas utilisable dans la boucle plus bas
								var max = this[0];
							}
							else{
								throw new Error('tableau vide ou première valeur du tableau n\'est pas un nombre');
							}
							...
							for (let i = 0; i < this.length; i++){
								if(!isNaN(this[i])){
									...
									throw new Error('une valeur n\'est pas un nombre');
								}
							}
							return max;
						},
...
/***********************  Ajax    ***********************************************/
/******************************************************************************************************/
function Xhr(){                // cr�ation d'un requete HTTP en fonction du navigateur
	let obj = null;
